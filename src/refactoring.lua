...
function Game:init(numColors, mode)
    -- perhaps could create a setting object that is created using all the settings or setting objects
    self.numColors = numColors
    self.mode = mode
    self.limit = limitClasses.new(self)
    self.gameBoard = Match3(DEFAULT_ROWS, DEFAULT_COLUMNS, numColors)
...
function gameBoard:init(rows, columns, numColors)
    self.rows = rows
